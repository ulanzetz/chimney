...
object dsl {
  ...
  final class TransformerVInto[From, To, C <: Cfg, VC <: VCfg](val source: From,
    ...
    def enableUnsafeOption: TransformerVInto[From, To, EnableUnsafeOption[C], VC] =
      new TransformerVInto[From, To, EnableUnsafeOption[C], VC](source, overrides, instances, overridesV)
